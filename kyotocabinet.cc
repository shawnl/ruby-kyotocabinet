...
static void define_module() {
  ...
  rb_define_module_function(mod_kc, "conv_str", kc_conv_str, 1);
  rb_define_module_function(mod_kc, "atoi", kc_atoi, 1);
  rb_define_module_function(mod_kc, "atoix", kc_atoix, 1);
  rb_define_module_function(mod_kc, "atof", kc_atof, 1);
  rb_define_module_function(mod_kc, "hash_murmur", kc_hash_murmur, 1);
  rb_define_module_function(mod_kc, "hash_fnv", kc_hash_fnv, 1);
  rb_define_module_function(mod_kc, "levdist", kc_levdist, -1);
...
static void define_err() {
  ...
  rb_define_private_method(cls_err, "initialize", err_initialize, -1);
  rb_define_method(cls_err, "set", err_set, 2);
  rb_define_method(cls_err, "code", err_code, 0);
  rb_define_method(cls_err, "name", err_name, 0);
  rb_define_method(cls_err, "message", err_message, 0);
  rb_define_method(cls_err, "to_i", err_code, 0);
  rb_define_method(cls_err, "to_s", err_to_s, 0);
  rb_define_method(cls_err, "inspect", err_inspect, 0);
  rb_define_method(cls_err, "==", err_op_eq, 1);
  rb_define_method(cls_err, "!=", err_op_ne, 1);
...
static void define_vis() {
  ...
  rb_define_method(cls_vis, "visit_full", vis_visit_full, 2);
  rb_define_method(cls_vis, "visit_empty", vis_visit_empty, 1);
